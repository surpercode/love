...
# Give me good luck!!!
# newly modified in 2017/8/13 by Douyaguang
...
''')
	...
	questions = [
				...
				'''
                   When we walk together or eat together or do all the things together, which of the following things I like to do? (Multiple choice)
                   A holding your hand,      B take photos,      C can not help staring at you,      D praise your kindness and beauty''',
				'''
	...
	answers = [
              ...
              ['ABCDEFGHIJ', 'abcdefghij', 'A,B,C,D,E,F,G,H,I,J', 'A B C D E F G H I J', 'A, B, C, D, E, F, G, H, I, J', 'a, b, c, d, e, f, g, h, i, j', 'a b c d e f g h i j', 'a,b,c,d,e,f,g,h,i,j', 'All', 'all', 'ALL']
              ]
	...
	def response_answer(ans, i):
		...
		if i == 0:
			...
			if right:
				print ('Excellent, we have seen 5 films together, 3 times in Heshenghui, 1 time in Wanda, 1 time in JiangWan acitivity center. The number will continue to increase, perhaps it can often record, heihei!')
			else:
				print ('I am sorry, it is not correct. Think clearly, perhaps you missed some film. I believe you can give me a right answer is you are really wenjing.')
		elif i == 4:
			if right:
				print ('Yeah, right! This is one of the most unforgettable day in my life. I love you, I sent you gifts and wrote my love peoms to you. I love you, I love you, I love you. I am waiting for you and your love, wenjing.')
			else:
				print ('Oh, my god, you are wrong. It is unbelievable if you are really wenjing that you can forget this import day. So I must say that you are not wenjing in a large probability.')
		elif i == 5:
			if right:
				print ('Good answer! In 2017-05-20, I ran around the campus to creat this love track 520. I love you wenjing, wo ai ni, the track tell you my heart in the specical day!!!')
			else:
				print ('I am so sad that you do not know the track shape. You are not wenjing. Give me some time to cry. Yesterday the sweats, now the tears.')
		elif i == 6:
			if right:
				print ('HaHaHa, rigth answer, great! Wenjing have many pet phrases, all of them is very funny and interesting, I love all of them even thought it is axiba, qie, pi. I love you!!!')
			else:
				print ('Not exactly right. If you are wenjing, you will know all of the pet phrases, this is a question. But perhaps you do not know thems well because you said them without aware of them.')
		elif i == 7:
			if right:
				print ('Good, Right! It was such a sweety and wonderfull time when we went to different parks. We walked, talked, played kites, swing, took photos, saw the rivers and sea, enjoyed the trees flowers and all the beauties in the nature. There were smiling and laughing all over the world in my heart. I love you, wenjing!!!')
			else:
				print ('Wrong! You are not wenjing, I cannot help doing this decision. These wonderfull times are so sweet that I think we can not forget forever.')
		elif i == 8:
			if right:
				print ('HaHa, right, you know me, wenjing. I am a little bothered when I took photos time and time. Please forgive me, wenjing, your are so beautiful, my heart is on you, I want to record all the beauties of you, and it is also the love of me.')
			else:
				print ('I must say the answer is not right. I took photos and staring at you to record and appreciate your beauties, I fall into them, I love you, wenjing.')
		elif i == 9:
			if right:
				print ('Wenjing, you are wenjing, yeah, exactly right! We have done all of them. I am the most happiest person. I want to hold your hands and go through our lives till we are old. I love you.')
			else:
				print ('I am sorry, all of them have been done by wenjing and me. If you are wenjing, you will know the right answer. I love wenjing, but are you wenjing?')
		input()
		return right
